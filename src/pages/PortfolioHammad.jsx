...
const projects = [
  {
    title: 'EcomAbdullah Studio Website UI',
        ...
        <section className="scroll-mt-24">
          <div className="section-max-width">
            ...
            <div className="mt-4 space-y-4">
              {/* EcomAbdullah site – image & description horizontal on larger screens */}
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="h-28 sm:h-32 sm:w-64 flex-none rounded-lg border border-slate-700/70 bg-slate-950 flex items-center justify-center overflow-hidden relative mx-auto sm:mx-0">
                  <AnimatePresence mode="wait" initial={false}>
                    <motion.img
                      ...
                      alt="EcomAbdullah website UI design preview"
                ...
                <div className="sm:flex-1 rounded-lg border border-slate-700/70 bg-slate-950/80 p-2.5 sm:p-3 flex flex-col justify-between">
                  <p className="text-[11px] sm:text-xs text-slate-300 leading-relaxed">
                    EcomAbdullah&apos;s own studio site — a dark, clean layout that walks visitors from hero to team,
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="h-28 sm:h-32 sm:w-64 flex-none rounded-lg border border-slate-700/70 bg-slate-950 flex items-center justify-center overflow-hidden relative mx-auto sm:mx-0">
                  <AnimatePresence mode="wait" initial={false}>
                    <motion.img
                      ...
                      alt="EcomAbdullah Instagram graphic preview"
                      className="absolute inset-0 h-full w-full object-contain"
                      loading="lazy"
                      decoding="async"
                      initial={{ x: 40, opacity: 0 }}
                ...
                <div className="sm:flex-1 rounded-lg border border-slate-700/70 bg-slate-950/80 p-2.5 sm:p-3 flex flex-col justify-between">
                  <p className="text-[11px] sm:text-xs text-slate-300 leading-relaxed">
                    Social media posts for the EcomAbdullah brand — punchy, readable layouts that highlight wins,
