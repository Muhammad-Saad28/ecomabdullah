...
const projects = [
  {
    title: 'EcomAbdullah – Full Site Build',
    ...
    description:
      'Implemented the full front end for the EcomAbdullah studio site using a modern React + Vite setup with Tailwind and TypeScript, handling routing, layout, and component structure so the marketing team could focus on content.'
  },
  {
