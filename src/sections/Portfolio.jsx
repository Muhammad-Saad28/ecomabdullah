...
const memberPortfolios = [
  {
    ...
    intro:
      'Focused on Meta and TikTok ads, Shopify and WordPress funnels, and campaigns that turn attention into sales.',
    highlights: [
      'Full-funnel ad setups from cold prospecting to retargeting.',
      'Launch and optimization of high-converting Shopify product pages.',
      'Dashboard-first reporting so every decision is backed by numbers.'
    ],
    images: ['/Sales/1.png']
  },
  {
      ...
      <div className="section-max-width">
        <div className="flex items-end justify-between gap-4 mb-7">
          ...
          <p className="hidden sm:block max-w-sm text-xs text-slate-400">
            ...
            all under the EcomAbdullah brand.
          </p>
        </div>
